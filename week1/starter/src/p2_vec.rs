...
pub fn vectorized(a: Vec4, b: Vec4) -> Vec4 {
    ...
    let multiplied = vec4_mul(a, b);
    let summed = vec4_add(a, b);
    vec4_select(mask, multiplied, summed)
}
